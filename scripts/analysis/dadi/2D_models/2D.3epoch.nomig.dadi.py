...
def split_3epoch_nomig(params, ns, pts): 
    ...
    return fs
param_names=("nu1","t1","nuIR","nuMN")

lower_bound = [1e-5, 1e-5, 1e-5,1e-5]
upper_bound = [50,1,0.1,50] 
p0 = [1,0.01,0.01,30] # initial parameters


func=split_3epoch_nomig # set the functiion
...
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu1_scaled_dip","t1_scaled_gen","nuIR_scaled_dip","nuMN_scaled_dip")
scaled_popt=(Nanc,nu1_scaled_dip,t1_scaled_gen,nuIR_scaled_dip,nuMN_scaled_dip)
