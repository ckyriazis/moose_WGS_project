...
#$ -cwd
#$ -m bea
#$ -o /u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP/annotation_tables
#$ -e /u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP/annotation_tables
#$ -M ckyriazi
...
WKDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP
CHR=NC_037328.1
...
java -Xmx1g -jar ${GATK} -T SelectVariants -R ${REFERENCE} -V 9Moose_joint_VEP_${CHR}.vcf.gz -selectType SNP -o annotation_tables/${CHR}_snps.vcf
