...
modelName="1D.1Bottleneck.NRec52000.TRec800"
...
def bottleneck(params, ns, pts):
    ...
    phi = Integration.one_pop(phi, xx, 0.03, 4) # recovery
...
upper_bound = [0.1, 0.1] # max TB~2600, max nuB~2600
lower_bound = [1e-5, 1e-4] # min TB~0.26 gens, min nuB~1.3
p0 = [0.001,0.01] # initial parameters
...
Nanc=theta / (4*mu*L)
TB_scaled_dip=popt[0]*Nanc*2
nuB_scaled_dip=popt[1]*Nanc
#TF_scaled_gen=popt[2]*2*Nanc
scaled_param_names=("Nanc_FromTheta_scaled_dip","TB_scaled_dip","nuB_scaled_dip")
scaled_popt=(Nanc,TB_scaled_dip,nuB_scaled_dip)
