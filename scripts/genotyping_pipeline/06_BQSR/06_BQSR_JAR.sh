#!/bin/bash
#$ -l highp,h_rt=120:00:00,h_data=16G
#$ -pe shared 3
#$ -N moose_BQSR
#$ -cwd
#$ -m bea
#$ -o /u/home/c/ckyriazi/kirk-bigdata/moose/hogdeer_output/06_BQSR
#$ -e /u/home/c/ckyriazi/kirk-bigdata/moose/hogdeer_output/06_BQSR
#$ -M ckyriazi
...
OUTDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/hogdeer_output/06_BQSR/${1}
INDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/hogdeer_output/05_RemoveBadReads/${1}
...
-I ${INDIR}/${FILENAME}_RemoveBadReads.bam \
