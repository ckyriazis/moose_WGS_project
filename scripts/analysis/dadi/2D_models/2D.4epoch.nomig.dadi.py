...
def split_4epoch_nomig(params, ns, pts): 
    ...
    return fs
param_names=("nu1","nu2","t1","t2","nuIR","nuMN")

lower_bound = [1e-5, 1e-5, 1e-5,1e-5,1e-5,1e-5]
upper_bound = [50, 50, 0.1,0.1,1,50] 
p0 = [1,1,0.01,0.01,0.01,10] # initial parameters


func=split_4epoch_nomig # set the functiion
...
nuIR_scaled_dip=popt[4]*Nanc
nuMN_scaled_dip=popt[5]*Nanc
...
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu1_scaled_dip","nu2_scaled_dip","t1_scaled_gen","t2_scaled_gen","nuIR_scaled_dip","nuMN_scaled_dip")
scaled_popt=(Nanc,nu1_scaled_dip,nu2_scaled_dip,t1_scaled_gen,t2_scaled_gen,nuIR_scaled_dip,nuMN_scaled_dip)
