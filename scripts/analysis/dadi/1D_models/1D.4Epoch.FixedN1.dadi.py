...
# setting older bneck duration of 100 gen (100/(2*4000)~0.013)
# Then recovery is for 190 gen (190) ~ 0.024
# then final bottlenck is for 10 gen (10/8000)
# and size is 30/4000 = 0.0075
#
def fourEpoch(params, ns, pts): 
    nu2,nu3,t2,t3 = params
...
upper_bound = [5,20,0.5,0.5] 
lower_bound = [1e-4,5,1e-5,1e-5]
p0 = [0.01,15,0.01,0.01]
...
t2_scaled_gen=popt[2]*2*Nanc
t3_scaled_gen=popt[3]*2*Nanc
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu2_scaled_dip","nu3_scaled_dip","t2_scaled_gen","t3_scaled_gen")
scaled_popt=(Nanc,nu2_scaled_dip,nu3_scaled_dip,t2_scaled_gen,t3_scaled_gen)
