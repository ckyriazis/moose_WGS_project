#! /bin/bash
#$ -cwd
#$ -l highp,h_rt=12:00:00,h_data=12G 
#$ -pe shared 4
#$ -N moose_filtering
...
FILTER_SCRIPT=/u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/genotyping_pipeline/11_FilterVCFfile/cow_scripts/customVCFfilter_new.py
