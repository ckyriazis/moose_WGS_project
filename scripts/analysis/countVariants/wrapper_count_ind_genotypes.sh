...
suffix=_count_ind_geno_SYN_remove_fixed

script=/u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/analysis/countVariants/count_ind_genotypes.py


python $script --vcf  ${vcf%.vcf.gz}_proteincoding_synonymous.vcf.gz  --outdir ${outdir}${vcf%.vcf.gz}_results --outPREFIX coding${suffix}
