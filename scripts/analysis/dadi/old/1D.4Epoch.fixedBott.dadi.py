...
def fourEpoch(params, ns, pts): 
    ...
    return fs
param_names=("nuREC","nuCUR","tREC","tCUR")
...
upper_bound = [10,10,0.2,0.2] 
lower_bound = [1e-4,1e-4,1e-4,1e-4]
p0 = [1,2,0.01,0.001] 
# initial parameters guessing that bneck is ~10/13000 and recovery is ~13000/13000 and second recovery is ~26000/13000
# and that tBOT is 
