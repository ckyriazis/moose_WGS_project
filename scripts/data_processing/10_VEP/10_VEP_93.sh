...
#$ -N moose_VEP
#$ -o /u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP
#$ -e /u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP
#$ -m abe
#$ -M ckyriazi
...
VEPDIR=/u/home/c/ckyriazi/project-klohmuel/software/ensembl-vep
...
INDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/output/09_TrimAlternates_VariantAnnotator
OUTDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/output/10_VEP

INFILE=${INDIR}/9Moose_joint_VariantAnnotator_${Chrom}.vcf.gz
OUTFILE=${OUTDIR}/9Moose_joint_VEP_${Chrom}.vcf.gz

perl ${VEPDIR}/vep \
--dir ${VEPDIR} --cache --vcf --offline --sift b --species bos_taurus \
--canonical --allow_non_variant --symbol --force_overwrite \
--dir_cache /u/home/c/ckyriazi/project-klohmuel/software/ensembl-vep --cache_version 97 \
-i ${INFILE} \
-o STDOUT \
