...
modelName="2D.5epoch.fixedN1N3.nomig"
...
def split_5epoch_nomig(params, ns, pts): 
    ...
    return fs
param_names=("nu2","t2","nuIR","nuMN")
lower_bound = [1e-5, 1e-5, 1e-5,1e-5]
upper_bound = [1,0.1,0.1,30] 
p0 = [0.01,0.1,0.01,10] # initial parameters
...
t2_scaled_gen=popt[1]*2*Nanc
nuIR_scaled_dip=popt[2]*Nanc
nuMN_scaled_dip=popt[3]*Nanc
...
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu2_scaled_dip","t2_scaled_gen","nuIR_scaled_dip","nuMN_scaled_dip")
scaled_popt=(Nanc,nu2_scaled_dip,t2_scaled_gen,nuIR_scaled_dip,nuMN_scaled_dip)
