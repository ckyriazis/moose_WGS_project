...
Nanc=theta / (4*mu*L)
t3_scaled_gen=popt[0]*Nanc*2
nu3_scaled_dip=popt[1]*Nanc
scaled_param_names=("Nanc_FromTheta_scaled_dip","t3_scaled_gen","nu3_scaled_dip")
scaled_popt=(Nanc,t3_scaled_gen,nu3_scaled_dip)
