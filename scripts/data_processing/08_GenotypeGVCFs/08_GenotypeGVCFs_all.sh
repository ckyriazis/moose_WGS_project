...
#$ -cwd
#$ -m bea
#$ -o /u/home/c/ckyriazi/kirk-bigdata/moose/output/08_GenotypeGVCFs/
#$ -e /u/home/c/ckyriazi/kirk-bigdata/moose/output/08_GenotypeGVCFs/
#$ -M ckyriazi
...
-stand_call_conf 0 \
-L ${Chrom} \
$(for Individual in "${AllIndividuals[@]}"; do echo "-V /u/home/c/ckyriazi/kirk-bigdata/moose/output/07_GATKHC/${Individual}/${Individual}_${Chrom}_GATK_HC.g.vcf.gz"; done) \
-o ${OutDir}/9Moose_joint_${Chrom}.vcf.gz
