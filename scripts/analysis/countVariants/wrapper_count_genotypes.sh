...
#$ -pe shared 4
#$ -N countGeno
#$ -o /u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/analysis/countVariants/runfiles
#$ -e /u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/analysis/countVariants/runfiles
#$ -m abe
#$ -M ckyriazi
...
suffix=_remove_fixed1

script=/u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/analysis/countVariants/count_genotypes.py
