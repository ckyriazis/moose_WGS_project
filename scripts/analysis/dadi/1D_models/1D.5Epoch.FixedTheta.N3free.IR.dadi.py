...
modelName="1D.5Epoch.FixedTheta.N3free.IR"
...
def fiveEpoch(params, ns, pts): 
    ...
    return fs
param_names=("nu3","t4","nu4")

upper_bound = [50,0.00081,0.1] 
lower_bound = [1,0.00079,1e-4]
p0 = [20,0.0008,0.01]
...
Nanc=theta1 / (4*mu*L)
nu3_scaled_dip=popt[0]*Nanc
t4_scaled_gen=popt[1]*Nanc*2
nu4_scaled_dip=popt[2]*Nanc
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu3_scaled_dip","t4_scaled_gen","nu4_scaled_dip")
scaled_popt=(Nanc,nu3_scaled_dip,t4_scaled_gen,nu4_scaled_dip)
