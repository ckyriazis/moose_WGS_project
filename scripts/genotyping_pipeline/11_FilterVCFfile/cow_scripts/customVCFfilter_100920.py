...
# Max depth (99% of chr 27)
maxD={'IR3925':54,'IR3927':55,'IR3928':45,'IR3929':50,'IR3931':57,'MN31':86,
      'MN41':64,'MN54':50,'MN96':47,'IR3930':41,'IR3934':40,'MN15':45,'MN178':38,
      'MN72':35,'MN76':37,'MN92':44, 'C06':39, 'HM2013':32, 'JC2001':25,'R199':43,'SMoose':48}
...
for line0 in VCF:
    if line0.startswith('#'):
        if line0.startswith('##FORMAT'):
            ...
            sys.stdout.write('##FILTER=<ID=WARN_missing,Description="Excess missingness (>100% of samples uncalled or set to missing).">\n')
            ...
            sys.stdout.write('##FILTER=<ID=FAIL_excessHet,Description="Excess heterozygosity (>35% of genotypes are 0/1).">\n')
