...
def fiveEpoch(params, ns, pts): 
    ...
    return fs
param_names=("nu2","nu3","nu4","t2","t3","t4")

upper_bound = [5,20,20,0.5,0.5,0.5] 
lower_bound = [1e-4,1e-4,1e-4,1e-5,1e-5,1e-5]
p0 = [0.01,1,10,0.01,0.01,0.01]



func=fiveEpoch # set the function
...
Nanc=theta / (4*mu*L)
nu2_scaled_dip=popt[0]*Nanc
nu3_scaled_dip=popt[1]*Nanc
nu4_scaled_dip=popt[2]*Nanc
t2_scaled_gen=popt[3]*2*Nanc
t3_scaled_gen=popt[4]*2*Nanc
t4_scaled_gen=popt[5]*2*Nanc
scaled_param_names=("Nanc_FromTheta_scaled_dip","nu2_scaled_dip","nu3_scaled_dip","nu4_scaled_dip","t2_scaled_gen","t3_scaled_gen","t4_scaled_gen")
scaled_popt=(Nanc,nu2_scaled_dip,nu3_scaled_dip,nu4_scaled_dip,t2_scaled_gen,t3_scaled_gen,t4_scaled_gen)
