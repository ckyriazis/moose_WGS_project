...
# Filtering DP > 379 - 99% of chr1 DP
...
OUTDIR=/u/home/c/ckyriazi/kirk-bigdata/moose/output/11_FilterVCFfile
...
INFILE=${INDIR}/9Moose_joint_VEP_${Chrom}.vcf.gz
OUTFILE=${OUTDIR}/9Moose_joint_11_FilterA_Round4_${Chrom}.vcf.gz
...
-filter "DP >379 " --filterName "FAIL_DP" \
-L ${Chrom} \
-V ${INFILE} \
-o ${OUTFILE}
...
FILTER_SCRIPT=/u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/11_FilterVCFfile/cow_scripts/customVCFfilter.py

INFILE2=${OUTDIR}/9Moose_joint_11_FilterA_Round4_${Chrom}.vcf.gz
OUTFILE2=${OUTDIR}/9Moose_joint_FilterB_Round4_${Chrom}.vcf.gz
