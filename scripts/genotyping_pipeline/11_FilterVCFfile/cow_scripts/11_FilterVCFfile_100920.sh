...
INFILE=${INDIR}/21Moose_joint_VEP_${Chrom}.vcf.gz
OUTFILE=${OUTDIR}/21Moose_joint_FilterA_Round${ROUND}_${Chrom}.vcf.gz
...
-filter "DP >763 " --filterName "FAIL_DP" \
-L ${Chrom} \
-V ${INFILE} \
-o ${OUTFILE}
...
FILTER_SCRIPT=/u/home/c/ckyriazi/project-klohmuel/moose_pipeline/scripts/genotyping_pipeline/11_FilterVCFfile/cow_scripts/customVCFfilter_100920.py

INFILE2=${OUTDIR}/21Moose_joint_FilterA_Round${ROUND}_${Chrom}.vcf.gz
OUTFILE2=${OUTDIR}/21Moose_joint_FilterB_Round${ROUND}_${Chrom}.vcf.gz
