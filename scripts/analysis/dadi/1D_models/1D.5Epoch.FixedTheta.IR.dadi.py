...
modelName="1D.5Epoch.FixedTheta.IR"
...
upper_bound = [0.00062,0.1] 
lower_bound = [0.00060,1e-4]
p0 = [0.00061,0.01]
...
scaled_param_names=("Nanc_FromTheta_scaled_dip","t4_scaled_gen","nu4_scaled_dip")
scaled_popt=(Nanc,t4_scaled_gen,nu4_scaled_dip)
